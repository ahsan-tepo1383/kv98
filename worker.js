...
<head>
  ...
  <script>
    ...
    function selectGoal(goal) {
      ...
      const recText = {
        '馃殌 Speed': 'For maximum speed, VLESS/Trojan with TLS on ports 443/8443 is recommended.',
        '馃敀 Security': 'For maximum security, Trojan with TLS on port 443 is recommended.',
        '馃寪 Bypass': 'For bypassing restrictions, VMESS/VLESS with multiple ports and IPv6 is recommended.'
      }[goal];
...
<body>
  ...
  <div class="container" id="mainPanel">
    ...
    <button class="save-button" onclick="startWizard()" style="background-color: #3B82F6;">馃鈥嶁檪锔� Start Configuration Wizard</button>
  ...
  <div class="container" id="wizardPanel" style="display: none;">
    <div class="wizard-container">
      ...
      <div class="wizard-step active" id="step1">
        ...
        <div class="wizard-option" onclick="selectGoal('馃殌 Speed')">
          <div class="wizard-option-icon">馃殌</div>
          <div>Maximum Speed</div>
        </div>
        <div class="wizard-option" onclick="selectGoal('馃敀 Security')">
          <div class="wizard-option-icon">馃敀</div>
          <div>Maximum Security</div>
        </div>
        <div class="wizard-option" onclick="selectGoal('馃寪 Bypass')">
          <div class="wizard-option-icon">馃寪</div>
